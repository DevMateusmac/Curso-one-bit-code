...
function handleWin(regions){
  ...
  let playerName = document.getElementById(turnPlayer).value
  document.querySelector('h2').innerHTML = playerName + ' venceu!'
}

function handleBoardClick(ev){
  let span = ev.currentTarget
  let region = span.dataset.region //N.N
  let rowColumPair = region.split('.') // ["N", "N"]
  let row = rowColumPair[0]
  let column = rowColumPair[1]

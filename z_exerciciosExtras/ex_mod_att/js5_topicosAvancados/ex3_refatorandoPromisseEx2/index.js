//refatorando código do ex2 com async e await
...
async function calcIMC(weight, height){
  ...
  if(typeof weight !== 'number' || typeof height !== 'number'){      
    return Promise.reject('Os dados fornecidos devem ser do tipo "number".')      
  }else{
...
async function initializeCalc(weight, height){  
  try{
    let result = await calcIMC(weight, height)
